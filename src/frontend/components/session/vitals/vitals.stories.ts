...
import './vitals.lit';
import { StorybookSessionMock, StorybookGameData, applyGameState } from '../../../../../stories/mocks/index';
  ...
  render: () => {
    ...
    setTimeout(() => {
      ...
      StorybookSessionMock.emitEvent('metadata/progressBar/mana',
        StorybookGameData.createVitalUpdate('mana', 80, 80)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/stamina',
        StorybookGameData.createVitalUpdate('stamina', 90, 90)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/spirit',
        StorybookGameData.createVitalUpdate('spirit', 100, 100)
      );
...
export const CriticalHealth: Story = {
  render: () => {
    ...
    setTimeout(() => {
      ...
      StorybookSessionMock.emitEvent('metadata/progressBar/mana',
        StorybookGameData.createVitalUpdate('mana', 5, 80)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/stamina',
        StorybookGameData.createVitalUpdate('stamina', 20, 90)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/spirit',
        StorybookGameData.createVitalUpdate('spirit', 85, 100)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/mindState', {
...
export const MixedStates: Story = {
  render: () => {
    ...
    setTimeout(() => {
      // Mixed vital states
      StorybookSessionMock.emitEvent('metadata/progressBar/health',
        StorybookGameData.createVitalUpdate('health', 75, 100)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/mana',
        StorybookGameData.createVitalUpdate('mana', 25, 80)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/stamina',
        StorybookGameData.createVitalUpdate('stamina', 45, 90)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/spirit',
        StorybookGameData.createVitalUpdate('spirit', 100, 100)
      );
...
export const IndeterminateStates: Story = {
  render: () => {
    ...
    setTimeout(() => {
      ...
      StorybookSessionMock.emitEvent('metadata/progressBar/stamina',
        StorybookGameData.createVitalUpdate('stamina', 70, 90)
      );
...
export const VitalsPanelDemo: Story = {
  render: () => {
    ...
    setTimeout(() => {
      ...
      StorybookSessionMock.emitEvent('metadata/progressBar/health',
        StorybookGameData.createVitalUpdate('health', 92, 100)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/mana',
        StorybookGameData.createVitalUpdate('mana', 45, 80)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/stamina',
        StorybookGameData.createVitalUpdate('stamina', 88, 90)
      );
      StorybookSessionMock.emitEvent('metadata/progressBar/spirit',
        StorybookGameData.createVitalUpdate('spirit', 100, 100)
      );
