...
describe("SessionLayout", () => {
  ...
  describe("Main area components rendering", () => {
    ...
    it("should render feed component with session", async () => {
      ...
      const feed = sessionUI.shadowRoot?.querySelector("illthorn-feed-modernized-lit") as FeedModernized;
      expect(feed).toBeTruthy();
    ...
    it("should render cli wrapper with prompt and cli components", async () => {
      ...
      const promptContainer = cliWrapper?.querySelector("illthorn-prompt-container") as PromptContainer;
      expect(promptContainer).toBeTruthy();
      expect(promptContainer.session).toBe(mockSession);
  ...
  describe("getSessionUI method", () => {
    ...
    it("should return components with proper types", async () => {
      ...
      expect(sessionUIObj.prompt?.tagName.toLowerCase()).toBe("illthorn-prompt-container");
  ...
  describe("API compatibility with original factory", () => {
    it("should maintain same component hierarchy as makeSessionUI", async () => {
      ...
      expect(sessionUI.shadowRoot?.querySelector("illthorn-prompt-container")).toBeTruthy();
